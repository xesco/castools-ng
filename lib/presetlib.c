...
static const AudioProfile profiles[] = {
    // Standard Profiles
    {
        ...
        .rationale = "Sine wave for reliable real MSX hardware playback, smooth waveform matches original cassette tapes"
    },
    ...
    // Problem-Solving Profiles
    {
        ...
        .rationale = "Maximum safety: sine wave for best MSX hardware compatibility, long leader, filtered, lower amplitude for headroom"
    },
    {
        .name = "tape-recording",
    ...
    // Quality Profiles
    {
        ...
        .enable_lowpass = true,
        .lowpass_cutoff_hz = 6500,
        .rationale = "Optimized sine wave for best signal quality, moderate levels for headroom"
    },
    {
        .name = "vintage-tape",
